...
const saveToStorage = document.getElementById("btnSaveItems");
...
const storeRecords = localStorage.getItem("records");
if (storeRecords) {
  arrRecords = JSON.parse(storeRecords);
}
iterateRecords();
